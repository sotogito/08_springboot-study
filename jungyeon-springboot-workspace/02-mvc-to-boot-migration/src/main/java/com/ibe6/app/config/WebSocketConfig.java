package com.ibe6.app.config;

import com.ibe6.app.handler.ChatEchoHandler;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(chatEchoHandler, "/chat")                   // /chat 요청시 해당 웹소켓 핸들러가 구동되면서 웹소켓 통인을 할 수 있도록
