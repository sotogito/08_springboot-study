...
import com.jjanggu.app.mapper.UserMapper;
import com.jjanggu.app.util.FileUtil;
...
public class UserServiceImpl implements UserService{
    ...
    public Map<String, Object> modifyUserProfile(String userId, MultipartFile file) {
        ...
        if(selectedUser == null){ // 예외사항1. 조회된 회원이 없을 경우
        ...
        }catch (Exception e){ // 예외사항2. 파일 저장시 문제 발생
            e.printStackTrace();
